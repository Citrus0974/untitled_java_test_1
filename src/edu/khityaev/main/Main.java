...
//        System.out.println(edu.khityaev.math.MyMath.sum(10, 12));
        ...
        int [] arr = {4, 7, 1, 10, 9};
//        System.out.println(edu.khityaev.math.MyMath.arrMax(arr));
//        int [] arr2 = null;
//        int [] arr3 = {};
//        System.out.println(edu.khityaev.math.MyMath.arrMax(arr3));
//        System.out.println(edu.khityaev.math.MyMath.arrMax(arr2));
//
//        arr = edu.khityaev.NewArray.InsertInArray(arr, 3, 11);
...
//        edu.khityaev.life.Human h1 = new edu.khityaev.life.Human();
//        h1.name="Клеопатра";
//        h1.height=152;
//        System.out.println(h1);
//        edu.khityaev.life.Human h2 = new edu.khityaev.life.Human();
//        h2.name="Пушкин";
//        h2.height=167;
//        System.out.println(h2);
//        edu.khityaev.life.Human h3 = new edu.khityaev.life.Human();
//        h3.name = "Александр";
//        h3.height = 189;
