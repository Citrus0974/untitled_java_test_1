...
//        edu.khityaev.university.Student s1 = new edu.khityaev.university.Student("Вася", 3,4,5);
//        edu.khityaev.university.Student s2 = new edu.khityaev.university.Student("Петя");
//        s2.marks=s1.marks;
//        s2.marks[0]=5;
//        System.out.println(s1);
//        System.out.println(s2);
//        System.out.println("ссылка на один и тот же массив скопировалась, а не само содержание массива");
//        edu.khityaev.university.Student s3 = new edu.khityaev.university.Student("Андрей");
...
//        System.out.println(s1);
        ...
        System.out.println(a);
        //попытка номер два через дополнительную сущность edu.khityaev.roads.WayToTown
